...
public class AndOrXor {
	public static void main(String[] args) {
		...
		// 5 = 0 1 0 1
		// 9 = 1 0 0 1
		// 5 & 9 = 0 0 0 1 <--since the one column is the only column that both have a
		// 1, the result is just 1.
		// Example:
		...
		// 5 = 0 1 0 1
		// 9 = 1 0 0 1
		// 5 | 9 = 1 1 0 1 <--If there is a 1 in the 5 or 9 column, it produces a 1 in
		// the same column in the result.
		// Example:
		// What is the value of 2 | 6?
		// 2 = 0 1 0
		// 6 = 1 1 0
		...
		// 3 = 0 1 1
		// 7 = 1 1 1
		// 3 ^ 7 = 1 0 0 <--When the two bits being compared are different, the
		// resulting bit is 1. Otherwise, 0.
		// Example:
